            ...
            var methods = {
                ...
                init: function(options) {
                    ...
                    function attach() {
                         ...
                         */
                        function createMenuItem(value, title, selected, search) {
                            ...
                            title = title
                                ...
                                .replace(/>/g, '&gt;')
                                .replace(/"/g, '&quot;')
                                .replace(new RegExp(search, 'gi'), '<strong style="color:blue;">'+search+'<\/strong>');
                                    ...
                                    jQuery.each(container, function(key, val) {
                                        if (propOption(val[settings.respondVars.value])) {
                                            list.append(createMenuItem(val[settings.respondVars.value],
                                                val[settings.respondVars.title],false,searchParam));
                                        } else {
                                            if (!settings.hideSelected) {
                                                list.append(createMenuItem(val[settings.respondVars.value],
                                                    val[settings.respondVars.title], true, searchParam));
                                            }
                                        }
                                    });
                                    listDisable();
